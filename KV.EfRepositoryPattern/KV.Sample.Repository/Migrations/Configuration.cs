namespace KV.Sample.Repository.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            teacher.ObjectState = RepositoryPattern.Infrastructure.ObjectState.Added;
            teacher.Name = "Professor Um";

            Teacher teacher2 = new Teacher();
            teacher2.ObjectState = RepositoryPattern.Infrastructure.ObjectState.Added;
            teacher2.Name = "Professor Dois";

            Course course1 = new Course();
            course1.ObjectState = RepositoryPattern.Infrastructure.ObjectState.Added;
            ...
            course2.ObjectState = RepositoryPattern.Infrastructure.ObjectState.Added;
